function display_overlay(jointsLocation, videoName, cameraParams, rotationMatrix, translationVector, faces, verts)
...
function disp_projections(imagePoints, videoName, faces, verts)
...
while hasFrame(vidObj)
    ...
    if exist('verts')
        TR = triangulation(double(faces+1),squeeze(verts(counter,:,:)));
